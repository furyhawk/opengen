...
import 'package:login_api/src/serializers.dart';
import 'package:login_api/src/auth/api_key_auth.dart';
import 'package:login_api/src/auth/basic_auth.dart';
import 'package:login_api/src/auth/bearer_auth.dart';
import 'package:login_api/src/auth/oauth.dart';
import 'package:login_api/src/api/items_api.dart';
import 'package:login_api/src/api/login_api.dart';
import 'package:login_api/src/api/private_api.dart';
import 'package:login_api/src/api/users_api.dart';
import 'package:login_api/src/api/utils_api.dart';
...
class LoginApi {
  ...
  LoginApi getLoginApi() {
    return LoginApi(dio: dio, serializers: serializers);
  }
