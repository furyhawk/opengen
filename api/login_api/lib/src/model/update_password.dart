...
abstract class UpdatePassword
    implements Built<UpdatePassword, UpdatePasswordBuilder> {
  ...
  factory UpdatePassword([void updates(UpdatePasswordBuilder b)]) =
      _$UpdatePassword;
  ...
  static Serializer<UpdatePassword> get serializer =>
      _$UpdatePasswordSerializer();
}

class _$UpdatePasswordSerializer
    implements PrimitiveSerializer<UpdatePassword> {
  @override
